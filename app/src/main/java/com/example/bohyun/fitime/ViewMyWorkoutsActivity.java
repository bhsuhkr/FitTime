...
//                    Toast.makeText(ViewMyExercisesActivity.this, Arrays.toString(MainActivity.exerciseList.toArray()), Toast.LENGTH_SHORT).show();
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        startActivity(new Intent(ViewMyWorkoutsActivity.this, ViewExerciseActivity.class));
                    }
                });
                addButton.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        startActivity(new Intent(ViewMyWorkoutsActivity.this, AddExerciseActivity.class));
                    }
                });
            }
